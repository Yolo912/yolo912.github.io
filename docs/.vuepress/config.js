...
const DOMAIN_NAME = 'yolo521.icu' // 域名 (不带https)
...
module.exports = {
    ...
    title: "912doc",
    description: 'w文档博客',
    base: '/yolo912.github.io/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
    ...
    themeConfig: {
        ...
        repo: 'Yolo912/yolo912.github.io', // 导航栏右侧生成Github链接
        ...
        author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
            name: 'Yolo912', // 必需
            href: 'https://github.com/Yolo912' // 可选的
        },
            ...
            icons: [
                {
                    ...
                    title: '发邮件',
                    link: 'mailto:193237147@qq.com'
                },
                {
                    iconClass: 'icon-github',
                    title: 'GitHub',
                    link: 'https://github.com/Yolo912'
                }
            ]
        },
        footer: { // 页脚信息
            createYear: 2023, // 博客创建年份
            copyrightInfo: 'Yolo912 | MIT License', // 博客版权信息，支持a标签
        },
        htmlModules,
    },
